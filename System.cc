...
void System::SaveMapPoints(const string &filename) {
    ...
    {
	//cout << endl << vpKFs[i]->mTimeStamp << endl;
	// frames_1
        //if ((vpKFs[i]->mTimeStamp) > 20171126.204751 || (vpKFs[i]->mTimeStamp) < 20171126.204734)

	// frames_2
	//if ((vpKFs[i]->mTimeStamp) > 20171126.212158 || (vpKFs[i]->mTimeStamp) < 20171126.212146)

	// frames_3
	//if ((vpKFs[i]->mTimeStamp) > 20170927.141313 || (vpKFs[i]->mTimeStamp) < 20170927.141252)

	// frames_4
	//if ((vpKFs[i]->mTimeStamp) > 20171126.215412 || (vpKFs[i]->mTimeStamp) < 20171126.215359)
	// no frames_5
	
	// frames_6
	if ((vpKFs[i]->mTimeStamp) > 20171126.225241 || (vpKFs[i]->mTimeStamp) < 20171126.225224)
